...
class SimFrame(ttk.Frame):
    def __init__(self, parent, main_gui):
        ...
        ttk.Label(self.manage_sims_frame, text="Batch #:").grid(row=0, column=0)
        ...
        self.default_params_df = pd.read_csv('/mnt/analysis/e17023/Adam/gadget_analysis/Simulations/.input/defaultParams.csv') #TODO: non-hardcoded path
    ...
    def sim_start_button_clicked(self):
        ...
        sim_queue = pd.read_csv('/mnt/analysis/e17023/Adam/gadget_analysis/Simulations/parameters.csv')
        ...
        sim_queue.to_csv('/mnt/analysis/e17023/Adam/gadget_analysis/Simulations/parameters.csv', index=False)
        
        # run the simulation
        subprocess.run([f'/mnt/analysis/e17023/Adam/gadget_analysis/Simulations/run_sim.sh', '-m4'])
    ...
    def sim_add_to_queue(self):
        sim_queue = pd.read_csv('/mnt/analysis/e17023/Adam/gadget_analysis/Simulations/parameters.csv') #TODO: non-hardcoded path
    ...
    def sim_reset_batch_clicked(self):
        sim_number = self.sim_batch_number_entry.get()
        if os.path.exists(f"/mnt/analysis/e17023/Adam/simulations/run_s{sim_number}"):
            num_components = len(os.listdir(f"/mnt/analysis/e17023/Adam/simulations/run_s{sim_number}/component_h5"))
            ...
            if input_str == 'yes':
                os.system(f"rm -r /mnt/analysis/e17023/Adam/simulations/run_s{sim_number}")
                os.system(f"rm /mnt/analysis/e17023/Adam/simulations/run_s{sim_number}.h5")
    ...
    def sim_batch_view(self):
        ...
        if os.path.exists(f"/mnt/analysis/e17023/Adam/simulations/run_s{sim_number}"):
            batch_composition = os.listdir(f"/mnt/analysis/e17023/Adam/simulations/run_s{sim_number}/component_h5")
