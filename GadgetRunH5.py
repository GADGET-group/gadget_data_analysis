...
class GadgetRunH5:
    def __init__(self, run_num, folder_path):
        ...
        self.h5_file_path = f"{h5_dir}run_{run_num}.h5"
    ...
    def make_image(self, index, save_path=None, show=False):
        '''
        ...
        plt.title(f' Image {self.good_events[index]} of {title} Event:', fontdict = {'fontsize' : 20})
