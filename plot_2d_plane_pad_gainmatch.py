...
data = np.load('/egr/research-tpc/dopferjo/gadget_analysis/run_121-128_proton_padgain.npy')
# print(np.shape(data))
...
plt.title('Pad Gainmatching for 20,000 Events in the 700 keV Proton Peak',fontsize=8)
# plt.subplot(2,1,1)
