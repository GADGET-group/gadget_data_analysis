...
gammas = ddas_interface.get_histogram(runs, (12000-1,1,12000), 'gammas', 'summed gamma spectrum', ddas_interface.get_summed_gamma_e_str())
...
tsbo = ddas_interface.get_histogram(runs, (200, 0, 0.22), '60Ga_decay_times', 'Time since beam off for 60Ga gamma rays (1003 keV & 3848 keV)',
                                    'time_since_beam_off', 'time_since_beam_off < 0.22 && ((%s>3840 && %s < 3855) || (%s > 1002 && %s < 1006))'%(s,s,s,s))
