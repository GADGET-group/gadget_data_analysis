...
protons_gated_on_491 = degai.get_histogram(runs,  adj_dict, cal_name, (3000, 0, 3000), 'protons_gated_on_491', 'proton energy (keV) gated on 491 keV gamma rays',
...
particle_gamma_dt = degai.get_histogram(runs, adj_dict, cal_name, (200, 0, 0.1), "particle_gamma_dt", "mesh_time - gamma time (s)", 
                                             ...
                                             nonlinearity_correction_name=nlc_name)
particle_gamma491_dt = degai.get_histogram(runs, adj_dict, cal_name, (200, 0, 0.1), "particle_gamma_dt", "mesh_time - gamma time (s)", 
...
gammaE_v_protonE = degai.get_histogram(runs, adj_dict, cal_name, (150, 0, 3000, 7000-150, 150, 7000), "gamma_v_proton_energy_time_gate", "gamma energy (keV) vs proton energy (keV) w/ expected (mesh time - gamma time)",
...
gammaE_v_protonE_accidental = degai.get_histogram(runs, adj_dict, cal_name, (150, 0, 3000, 7000-150, 150, 7000), "gamma_v_proton_energy_accidental_gate", 
