...
peaks = [#('60Zn', 670.3, 0.3, 665,677), #doesn't fit well, maybe another peak?
         ...
         ('60Ga', 1003.7, 0.2, 997, 1008), ('60Ga', 1554.9, 0.6, 1548,1563), #('60Ga', 2293.0, 1.0, 2287,2299), #this last one wants to have a very different sigma2 for some reason
...
sigma1_func = lambda E: 0.02023*np.sqrt(E + 878.9)
sigma2_func = lambda E: 0.03328*np.sqrt(E + 701.1)
tau1_func = lambda E: 0.0002246*E + 0.03052
tau2_func = lambda E: 4.442e-5*E + 0.04811
