...
mesh_vs_tpc_protons = ddas_interface.get_histogram(run, (4500, 0, 9000, 4500, 0, 9000), 'mesh_vs_tpc_energy', 'mesh vs tpc_energy', '(mesh_pre_amp_e/2.5)+52:tpc_energy', \
...
mesh_vs_tpc_alphas = ddas_interface.get_histogram(run, (500, 0, 9000, 500, 0, 9000), 'mesh_vs_tpc_energy', 'mesh vs tpc_energy', '(mesh_pre_amp_e/2.5)+52:tpc_energy', \
