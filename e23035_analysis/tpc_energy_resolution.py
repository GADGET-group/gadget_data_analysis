...
f_zn_test.peaks_to_fit = [([821,913], 600,980), ([1061, 1116, 1179,1263,1369,1465], 1020, 1500)]
f_zn_test.param_bound_functions = {'bg_slope':lambda E: (0,0) if E>1000 else (-1,1), 'sigma':sigma_func}
